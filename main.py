from addressparser import AddressParser, AddressMatcher, AddressFlagger
...
if __name__ == "__main__":
    ...
    AddressFlagger().parse_csv(file_path='data/2018-01-03.csv', cols=[3]).to_csv('data/flag.csv', index=False)
